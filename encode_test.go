...
var encTests = []encTest{
	...
	{val:129, output:"8181"},
	{val:int8(127), output:"7F"},
	{val:int8(-1<<6)+1, output:"81C1"},
	{val:int8(math.MaxInt8), output:"7F"},
	{val:int8(math.MinInt8), output:"8180"},
	{val:int16(math.MaxInt16), output:"827FFF"},
	{val:int16(math.MinInt16), output:"828000"},
	{val:int32(math.MaxInt32), output:"847FFFFFFF"},
	{val:int32(math.MinInt32), output:"8480000000"},
	{val:int64(math.MaxInt64), output:"887FFFFFFFFFFFFFFF"},
	{val:int64(math.MinInt64), output:"888000000000000000"},
