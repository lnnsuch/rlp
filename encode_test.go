...
var encTests = []encTest{
	...
	{val:int8(127), output:"017F"},
	{val:128, output:"018180"},
	{val:127, output:"017F"},
	{val:129, output:"018181"},
	{val:int8(127), output:"017F"},
	{val:-63, output:"003F"},
	{val:63, output:"013F"},
	{val:int8(math.MaxInt8), output:"017F"},
	{val:int8(math.MinInt8), output:"008180"},
	{val:int16(math.MaxInt16), output:"01827FFF"},
	{val:int16(math.MinInt16), output:"00828000"},
	{val:int32(math.MaxInt32), output:"01847FFFFFFF"},
	{val:int32(math.MinInt32), output:"008480000000"},
	{val:int64(math.MaxInt64), output:"01887FFFFFFFFFFFFFFF"},
	{val:int64(math.MinInt64), output:"00888000000000000000"},
	{val:int64(-1 << 15), output:"00828000"},
	{val:int64(-1 << 23), output:"0083800000"},
	{val:int64(-1 << 31), output:"008480000000"},
	{val:int64(-1 << 39), output:"00858000000000"},
	{val:int64(-1 << 47), output:"0086800000000000"},
	{val:int64(-1 << 55), output:"008780000000000000"},
	...
	{val: &intField{X: 3}, output: "C20103"},

	// nil
	{val: (*uint)(nil), output: "80"},
	{val: (*int)(nil), output: "80"},
